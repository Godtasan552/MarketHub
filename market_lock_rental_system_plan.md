...
#### 4.3.3 ระบบคิว (Queue System)
- หากมีหลายคนจองล็อคเดียวกัน → เข้าคิว **FIFO** (First In First Out)
- **คนแรกในคิว** ต้องชำระภายใน **3 ชั่วโมง**
- หากไม่ชำระ → ยกเลิกอัตโนมัติ + **คนที่ 2 เลื่อนขึ้นมาแทน**
- คนที่ 2 ได้รับการแจ้งเตือนทันที พร้อมเวลาชำระ 3 ชั่วโมง (countdown ใหม่)
- กระบวนการนี้ทำต่อเนื่องจนกว่าจะมีคนชำระสำเร็จ
...
### 4.8 ประวัติการเช่า (Rental History)
- แสดงรายการเช่าทั้งหมดที่ผ่านมา
- Filter ตาม: สถานะ, วันที่, โซน
...
#### Rule 5: Queue System with Auto-Promotion
- หากมีหลายคนจองล็อคเดียวกัน → เข้าคิว FIFO
- **คนแรก** ต้องชำระใน 3 ชม.
- หากไม่ชำระ → ยกเลิก + **คนที่ 2 เลื่อนขึ้นอัตโนมัติ**
- คนที่ 2 ได้รับแจ้งเตือนทันที + countdown 3 ชม. ใหม่
- ทำต่อเนื่องจนกว่าจะมีคนชำระสำเร็จ หรือคิวหมด
